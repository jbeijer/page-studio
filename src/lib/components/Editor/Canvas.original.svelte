<script>
  ...
  onMount(() => {
    ...
    // NOTE: We no longer need to initialize layer functions here as they're directly implemented as exported functions
    console.log("Layer management functions already initialized");
  ...
  // Initialize with empty stubs that will be replaced with real implementations
  // Direct implementation outside onMount to make these functions always available
  ...
  export let copySelectedObjects = () => { console.warn("copySelectedObjects not yet initialized"); };
  export let cutSelectedObjects = () => { console.warn("cutSelectedObjects not yet initialized"); };
  export let pasteObjects = () => { console.warn("pasteObjects not yet initialized"); };
